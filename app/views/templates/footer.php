<footer class="footer">
    <div class="footer__grid">
        <div class="footer__coontenido">
            <h3 class="footer__logo">&#60;DevWebCamp /></h3>
            <p class="footer__texto">
                DevWebCamp es una conferencia para desarrolladores de todos los niveles, se lleva a cabo de forma presencial y online
            </p>
        </div>
    ...
    <p class="footer__copyright">DevWebCamp <span class="footer__copyright--regular">- Todos los derechos reservados.</span></p>
</footer>